...
c4 = l1.cards.create(title: 'squats', description: 'feel the burn', ord: 3)
c5 = l1.cards.create(title: 'pushups', description: 'ooh ouch', ord: 2)
c6 = l1.cards.create(title: 'situps', description: 'ouchy', ord: 1)

c7 = l2.cards.create(title: 'squats', description: 'feel the burn', ord: 2)
c8 = l2.cards.create(title: 'pushups', description: 'ooh ouch', ord: 3)
c9 = l2.cards.create(title: 'situps', description: 'ouchy', ord: 1)
